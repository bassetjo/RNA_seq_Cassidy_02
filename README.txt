...
featureCounts.r
	...
	Reference:
			Liao Y, Smyth GK and Shi W (2014). featureCounts: an efficient general purpose
	...
	Analysis performed by John Bassett
		...
		*note* Annotation file (AnnotationDir) is GRCH38.89 Compare with UTAH annotation file GRCh38.85. IS this acceptable?

fcts.RData
	R data object containing the output generated from featureCounts.r
